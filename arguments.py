...
def get_args():
    ...
    parser.add_argument('--mask-dist', type=float, default=0.3, help='distance to restrict comms')
    ...
    parser.add_argument('--num-processes', type=int, default=24, help='how many training CPU processes to use (default: 32)')
    # parser.add_argument('--num-steps', type=int, default=320, help='number of forward steps in PPO (default: 128)')
    parser.add_argument('--no-cuda', action='store_true', default=False, help='disables CUDA training')
    parser.add_argument('--num-frames', type=int, default=int(50e6), help='number of frames to train')
    # parser.add_argument('--arena-size', type=int, default=1.5, help='size of arena')

    # evaluation
    parser.add_argument('--num-eval-episodes', type=int, default=100, help='number of episodes to evaluate with')
    parser.add_argument('--dist-threshold', type=float, default=0.05, help='distance within landmark is considered covered')
